...
// 讀取原始條款文件
const termsPath = path.join(__dirname, 'src', 'data', 'termsContent.ts');
let termsContent = fs.readFileSync(termsPath, 'utf8');

// 更新版本號和日期
termsContent = termsContent.replace(/version: '1\.0'/g, "version: '2.0'");
termsContent = termsContent.replace(/effectiveDate: new Date\('2024-01-01'\)/g, "effectiveDate: new Date('2024-08-22')");

// 更新購買政策中的服務描述
const purchasePolicyUpdates = `
### 1.1 核心功能
