...
export class S3Service {
  ...
  async uploadFile(
    ...
    try {
      ...
      const _response = await api.post(`/api/storage/s3/upload`, {
        key,
  ...
  async downloadFile(
    ...
    try {
      ...
      const _response = await api.get(`/api/storage/s3/download`, {
        params: {
          key,
          bucket: this.bucket,
          region: this.region,
  ...
  async deleteFile(key: string): Promise<ApiResponse> {
    try {
      ...
      const _response = await api.delete(`/api/storage/s3/delete`, {
        params: {
          key,
          bucket: this.bucket,
          region: this.region,
  ...
  async listFiles(options: S3ListOptions = {}): Promise<ApiResponse<S3File[]>> {
    try {
      ...
      const _response = await api.get(`/api/storage/s3/list`, {
        params: {
          bucket: this.bucket,
          region: this.region,
          prefix,
  ...
  async getFileUrl(
    ...
    try {
      ...
      const _response = await api.get(`/api/storage/s3/url`, {
        params: {
          key,
          bucket: this.bucket,
          region: this.region,
  ...
  async copyFile(
    ...
    try {
      ...
      const _response = await api.post(`/api/storage/s3/copy`, {
        sourceKey,
        destinationKey,
        bucket: this.bucket,
        region: this.region,
  ...
  async getFileMetadata(key: string): Promise<ApiResponse<S3File>> {
    try {
      ...
      const _response = await api.get(`/api/storage/s3/metadata`, {
        params: {
          key,
          bucket: this.bucket,
          region: this.region,
  ...
  async getServiceStats(): Promise<ApiResponse> {
    try {
      ...
      const _listResponse = await this.listFiles({ maxKeys: 1 });
...
export const _s3Service = new S3Service();
