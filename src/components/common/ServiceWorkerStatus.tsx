  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.statusGrid}>
          <View style={styles.statusItem}>
            ...
            <Text style={[styles.statusValue, status.registered ? styles.success : styles.error]}>
          ...
          <View style={styles.statusItem}>
            ...
            <Text style={[styles.statusValue, status.active ? styles.success : styles.error]}>
          ...
          <View style={styles.statusItem}>
            ...
            <Text style={[styles.statusValue, status.online ? styles.success : styles.error]}>
              {status.online ? '在線' : '離線'}
            </Text>
          </View>
          ...
          <View style={styles.statusItem}>
            ...
            <Text style={[styles.statusValue, status.waiting ? styles.warning : styles.success]}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.metricsGrid}>
          ...
          <View style={styles.metricItem}>
            ...
            <Text style={styles.metricValue}>{performanceMetrics.cacheMisses}</Text>
          </View>

          <View style={styles.metricItem}>
            <Text style={styles.metricLabel}>網絡請求</Text>
            <Text style={styles.metricValue}>{performanceMetrics.networkRequests}</Text>
          </View>
      ...
      {showDetails && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={refreshCacheInfo} style={styles.refreshButton}>
          ...
          {cacheInfo.map((cache, index) => (
            <View key={index} style={styles.cacheItem}>
              ...
              <View style={styles.cacheDetails}>
                <Text style={styles.cacheDetail}>大小: {formatFileSize(cache.size)}</Text>
                <Text style={styles.cacheDetail}>項目: {cache.itemCount}</Text>
                <Text style={styles.cacheDetail}>策略: {formatStrategy(cache.strategy)}</Text>
      ...
      {showDetails && (
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>同步隊列 ({syncQueue.length})</Text>
            <TouchableOpacity onPress={clearSyncQueue} style={styles.clearButton}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.buttonGrid}>
          ...
          <TouchableOpacity onPress={handlePrefetchResources} style={styles.button}>
            <Text style={styles.buttonText}>預取資源</Text>
          </TouchableOpacity>

          <TouchableOpacity onPress={handleBackgroundSync} style={styles.button}>
      ...
      {showAdvanced && (
        <View style={styles.section}>
          ...
          <TouchableOpacity onPress={refreshPerformanceMetrics} style={styles.button}>
