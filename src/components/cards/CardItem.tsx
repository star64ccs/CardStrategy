...
export const CardItem: React.FC<CardItemProps> = ({
  ...
  const renderCompactCard = () => (
    <Card style={styles.compactCard} variant="elevated" onPress={onPress}>
      <Image
  ...
  const renderDetailedCard = () => (
    <Card style={styles.detailedCard} variant="elevated" onPress={onPress}>
          ...
          {showCondition && card.condition && (
            <View
              style={[
                ...
                { backgroundColor: getConditionColor(card.condition) },
              ]}
            >
  ...
  const renderPremiumCard = () => (
    <Card style={styles.premiumCard} variant="outlined" onPress={onPress}>
      <View style={styles.premiumImageContainer}>
        ...
        <View style={styles.premiumOverlay}>
          <View style={styles.premiumBadges}>
            <View
              style={[
                styles.premiumRarityBadge,
                { backgroundColor: getRarityColor(card.rarity) },
              ]}
            >
              <Text style={styles.premiumRarityText}>
            ...
            {showCondition && card.condition && (
              <View
                style={[
                  styles.premiumConditionBadge,
                  { backgroundColor: getConditionColor(card.condition) },
                ]}
              >
                <Text style={styles.premiumConditionText}>
                  {card.condition.toUpperCase()}
                </Text>
              </View>
            )}
      ...
      <View style={styles.premiumInfo}>
        ...
        <Text style={styles.premiumNumber}>#{card.cardNumber}</Text>
