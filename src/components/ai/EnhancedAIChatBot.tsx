...
export const EnhancedAIChatBot: React.FC<EnhancedAIChatBotProps> = ({
  ...
  const generateSmartSuggestions = async (lastMessage: string) => {
    try {
      const response = await aiService.generateSuggestions(lastMessage, context);
  ...
  const containerStyle = mode === 'compact' ? styles.compactContainer : 
                        mode === 'floating' ? styles.floatingContainer : 
    ...
    <View style={[styles.container, containerStyle]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerRight}>
          ...
          >
            <MaterialIcons name="help" size={20} color={theme.colors.textSecondary} />
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.headerButton} 
