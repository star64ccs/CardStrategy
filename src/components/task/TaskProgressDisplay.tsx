    ...
    <View style={styles.overallProgressContainer}>
      ...
      <View style={styles.progressBarContainer}>
          ...
          <Animated.View
            style={[
              styles.progressBarFill,
              {
                ...
                backgroundColor:
                  progressSummary.overallProgress === 100
                    ? '#4CAF50'
                    : '#2196F3',
              },
            ]}
        ...
        <Text style={styles.progressText}>
          {progressSummary.overallProgress.toFixed(1)}%
        </Text>
      </View>
                ...
                <Animated.View
                  style={[
                    styles.progressBarFill,
                    {
                      ...
                      backgroundColor:
                        progress.percentage === 100 ? '#4CAF50' : '#2196F3',
                    },
                  ]}
                />
              </View>
