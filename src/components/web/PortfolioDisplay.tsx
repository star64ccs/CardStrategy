        ...
        <div style={styles.statsOverview}>
          ...
          <div style={styles.statCard}>
            <div style={{
              ...
              {getProfitIcon(stats.totalProfit)} {formatPrice(Math.abs(stats.totalProfit))}
            </div>
              ...
              <div style={styles.summaryCards}>
                ...
                <div style={styles.summaryCard}>
                  ...
                  <div style={styles.summaryItem}>
                    ...
                    <span style={styles.summaryValue}>
                      {stats.totalCost > 0
                        ? ((stats.totalValue / stats.totalCost) * 100).toFixed(1)
                        : 'N/A'}%
                    </span>
                  </div>
                </div>
                    ...
                    {portfolio.slice(0, 3).map((item) => (
                      <div key={item.id} style={styles.recentItem}>
                        ...
                        <div style={styles.recentInfo}>
                          ...
                          <div style={styles.recentQuantity}>數量: {item.quantity}</div>
                          <div style={styles.recentDate}>{formatDate(item.purchaseDate)}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    return (
                      <div key={item.id} style={styles.portfolioItem}>
                        ...
                        <div style={styles.itemInfo}>
                          ...
                          <div style={styles.itemRarity}>{item.card.rarity}</div>
                        </div>
                        ...
                        <div style={styles.itemPrice}>
                          ...
                          <div style={styles.priceValue}>{formatPrice(item.purchasePrice)}</div>
                        </div>
                        ...
                        <div style={styles.itemProfit}>
                          ...
                          <div style={{
                            ...
                            {getProfitIcon(profit)} {formatPrice(Math.abs(profit))}
                          </div>
                          <div style={{
