...
// Async thunks
export const _performAppraisal = createAsyncThunk(
  'appraisal/performAppraisal',
  async (request: AppraisalRequest, { rejectWithValue }) => {
    try {
      const _result = await appraisalService.performAppraisal(request);
      return result;
    } catch (error) {
...
export const _getAppraisalHistory = createAsyncThunk(
  'appraisal/getAppraisalHistory',
  async (cardId: string, { rejectWithValue }) => {
    try {
      const _history = await appraisalService.getAppraisalHistory(cardId);
      return history;
    } catch (error) {
      return rejectWithValue(error as AppraisalError);
    }
...
export const _getAppraisalStats = createAsyncThunk(
  'appraisal/getAppraisalStats',
  async (_, { rejectWithValue }) => {
    try {
      const _stats = await appraisalService.getAppraisalStats();
      return stats;
    } catch (error) {
      return rejectWithValue(error as AppraisalError);
    }
...
export const _getAppraisalOptions = createAsyncThunk(
  'appraisal/getAppraisalOptions',
  async (_, { rejectWithValue }) => {
    try {
      const _options = await appraisalService.getAppraisalOptions();
      return options;
    } catch (error) {
      return rejectWithValue(error as AppraisalError);
    }
...
const _appraisalSlice = createSlice({
  name: 'appraisal',
  initialState,
  reducers: {
...
// Selectors
export const _selectCurrentAppraisal = (state: { appraisal: AppraisalState }) =>
  state.appraisal.currentAppraisal;

export const _selectAppraisalHistory = (state: { appraisal: AppraisalState }) =>
  state.appraisal.history;

export const _selectAppraisalStats = (state: { appraisal: AppraisalState }) =>
  state.appraisal.stats;

export const _selectAppraisalOptions = (state: { appraisal: AppraisalState }) =>
  state.appraisal.options;

export const _selectAppraisalStatus = (state: { appraisal: AppraisalState }) =>
  state.appraisal.status;

export const _selectAppraisalError = (state: { appraisal: AppraisalState }) =>
  state.appraisal.error;

export const _selectAppraisalLoading = (state: { appraisal: AppraisalState }) =>
