...
export const _detectFakeCard = createAsyncThunk(
...
export const _batchDetectFakeCards = createAsyncThunk(
...
export const _fetchDetectionHistory = createAsyncThunk(
...
export const _fetchDetectionStats = createAsyncThunk(
...
export const _fetchFeatureTemplates = createAsyncThunk(
...
export const _reportFakeCard = createAsyncThunk(
...
// Slice
const _fakeCardDetectionSlice = createSlice({
...
// Selectors
export const _selectCurrentDetection = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.currentDetection;
export const _selectDetectionHistory = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.detectionHistory;
export const _selectDetectionStats = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.detectionStats;
export const _selectFeatureTemplates = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.featureTemplates;
export const _selectDetectionLoading = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.loading;
export const _selectDetectionError = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.error;
export const _selectLastDetectionId = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.lastDetectionId;
export const _selectSelectedCardId = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.selectedCardId;
export const _selectSelectedMethods = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.selectedMethods;
export const _selectBatchDetections = (state: {
  fakeCardDetection: FakeCardDetectionState;
}) => state.fakeCardDetection.batchDetections;
export const _selectReportForm = (state: {
  fakeCardDetection: FakeCardDetectionState;
