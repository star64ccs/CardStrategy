...
describe('QueryOptimizationService', () => {
  ...
  describe('查詢分析', () => {
    ...
    it('應該成功分析查詢', () => {
      ...
      const _analysis = queryOptimizationService.analyzeQuery(queryMetrics);
    ...
    it('應該正確分析複雜查詢', () => {
      ...
      const _analysis = queryOptimizationService.analyzeQuery(complexQuery);
  ...
  describe('查詢指標記錄', () => {
    ...
    it('應該成功記錄查詢指標', () => {
      ...
      const _report = queryOptimizationService.generatePerformanceReport();
  ...
  describe('批量優化', () => {
    ...
    it('應該成功批量優化查詢', () => {
      ...
      const _results = queryOptimizationService.batchOptimizeQueries(queries);
  ...
  describe('查詢模式分析', () => {
    ...
    it('應該返回查詢模式', () => {
      const _patterns = queryOptimizationService.getQueryPatterns();
  ...
  describe('性能測試', () => {
    ...
    it('應該支持並發分析', async () => {
      const _analyses = Array.from({ length: 10 }, (_, i) => {
        const queryMetrics: QueryMetrics = {
          queryId: `query-${i}`,
          sql: `SELECT * FROM table${i}`,
          executionTime: 100 + i * 10,
