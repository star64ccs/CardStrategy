  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        >
          <Text
            style={[styles.filterButtonText, { color: theme.colors.white }]}
          >
            篩選
          </Text>
        </TouchableOpacity>
              ...
              style={[
                styles.metricValue,
                {
                  color: getQualityColor(
                    dashboardData.overallMetrics.averageCompleteness
                  ),
                },
              ]}
            >
              {(dashboardData.overallMetrics.averageCompleteness * 100).toFixed(
                1
              )}
              %
            </Text>
          ...
          <View style={styles.metricItem}>
            ...
            <Text
              style={[
                ...
                {
                  color: getQualityColor(
                    dashboardData.overallMetrics.averageAccuracy
                  ),
                },
              ]}
            >
          ...
          <View style={styles.metricItem}>
            ...
            <Text
              style={[
                ...
                {
                  color: getQualityColor(
                    dashboardData.overallMetrics.averageConsistency
                  ),
                },
              ]}
            >
              {(dashboardData.overallMetrics.averageConsistency * 100).toFixed(
                1
              )}
              %
            </Text>
          ...
          <View style={styles.metricItem}>
            ...
            <Text
              style={[
                ...
                {
                  color: getQualityColor(
                    dashboardData.overallMetrics.averageTimeliness
                  ),
                },
              ]}
            >
              {(dashboardData.overallMetrics.averageTimeliness * 100).toFixed(
                1
              )}
              %
            </Text>
        ...
        <View style={styles.overallScore}>
          ...
          <Text
            style={[
              ...
              {
                color: getQualityColor(
                  dashboardData.overallMetrics.overallScore
                ),
              },
            ]}
          >
            ...
            data={[
              {
                name: '優秀',
                population:
                  dashboardData.qualityDistribution.overallDistribution
                    .excellent.count,
              ...
              },
              {
                name: '良好',
                population:
                  dashboardData.qualityDistribution.overallDistribution.good
                    .count,
              ...
              },
              {
                name: '一般',
                population:
                  dashboardData.qualityDistribution.overallDistribution.fair
                    .count,
              ...
              },
              {
                name: '較差',
                population:
                  dashboardData.qualityDistribution.overallDistribution.poor
                    .count,
      ...
      <Card style={styles.card}>
        ...
        <BarChart
          data={{
            labels: dashboardData.sourceBreakdown.sourceBreakdown.map(
              (item) => item.source
            ),
            datasets: [
              {
                data: dashboardData.sourceBreakdown.sourceBreakdown.map(
                  (item) => item.count
                ),
              },
            ],
      ...
      <Card style={styles.card}>
        ...
        {dashboardData.recentIssues.slice(0, 5).map((issue, index) => (
          <View key={index} style={styles.issueItem}>
            ...
            <Text
              style={[styles.issueDate, { color: theme.colors.textSecondary }]}
            >
      ...
      <Card style={styles.card}>
        ...
        {dashboardData.improvementSuggestions
          .slice(0, 5)
        ...
        <View style={styles.filterContent}>
          ...
          {dataTypes.map((dataType) => (
              ...
              onPress={() => {
                if (selectedDataTypes.includes(dataType.key)) {
                  setSelectedDataTypes((prev) =>
                    prev.filter((type) => type !== dataType.key)
                  );
                } else {
            ...
            >
              ...
              />
              <Text
                style={[styles.dataTypeLabel, { color: theme.colors.text }]}
              >
                {dataType.label}
              </Text>
            </TouchableOpacity>
