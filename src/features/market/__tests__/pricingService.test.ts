...
describe('PricingService', () => {
  ...
  describe('getInstance', () => {
    it('should return the same instance (singleton)', () => {
      const _instance1 = PricingService.getInstance();
      const _instance2 = PricingService.getInstance();
  ...
  describe('getPriceHistory', () => {
    ...
    it('should return price history for 7 days', async () => {
      const _history = await service.getPriceHistory('test_card_1', '7d');
    ...
    it('should return price history for 30 days', async () => {
      const _history = await service.getPriceHistory('test_card_2', '30d');
    ...
    it('should return price history for 90 days', async () => {
      const _history = await service.getPriceHistory('test_card_3', '90d');
    ...
    it('should calculate statistics correctly', async () => {
      const _history = await service.getPriceHistory('test_card_4', '7d');

      const _prices = history.data.map(d => d.price);
      const _volumes = history.data.map(d => d.volume);
  ...
  describe('createPriceAlert', () => {
    ...
    it('should create price alert successfully', async () => {
      ...
      const _alert = await service.createPriceAlert(alertData);
  ...
  describe('getUserAlerts', () => {
    ...
    it('should return empty array for non-existent card', async () => {
      const _alerts = await service.getUserAlerts('non_existent_card');
  ...
  describe('generateMarketAnalysis', () => {
    ...
    it('should generate market analysis', async () => {
      const _analysis = await service.generateMarketAnalysis('test_card_1');
  ...
  describe('edge cases and error handling', () => {
    ...
    it('should handle invalid period in history request', async () => {
      const _history = await service.getPriceHistory(
        'test_card_1',
        'invalid_period'
      );
