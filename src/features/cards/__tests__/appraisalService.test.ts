...
describe('AppraisalService', () => {
  ...
  describe('getInstance', () => {
    it('should return the same instance (singleton)', () => {
      const _instance1 = AppraisalService.getInstance();
      const _instance2 = AppraisalService.getInstance();
  ...
  describe('performAppraisal', () => {
    ...
    it('should perform appraisal successfully', async () => {
      const _result = await appraisalService.performAppraisal(mockRequest);
    ...
    it('should return valid grade based on score', async () => {
      ...
      const _validGrades = Object.keys(GRADE_STANDARDS);
  ...
  describe('getAppraisalStats', () => {
    ...
    it('should include all grade distributions', async () => {
      const _stats = await appraisalService.getAppraisalStats();
      const _expectedGrades = Object.keys(GRADE_STANDARDS);
  ...
  describe('error handling', () => {
    ...
    it('should handle invalid requests gracefully', async () => {
      ...
      const _result = await appraisalService.performAppraisal(invalidRequest);
      expect(result).toBeDefined();
  ...
  describe('statistics tracking', () => {
    ...
    it('should track appraisal statistics correctly', async () => {
      const _initialStats = await appraisalService.getAppraisalStats();
      const _initialTotal = initialStats.totalAppraisals;
      ...
      const _updatedStats = await appraisalService.getAppraisalStats();
