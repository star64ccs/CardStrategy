...
describe('CardRecognitionService', () => {
  ...
  describe('initialize', () => {
    ...
    it('should handle initialization errors', async () => {
      const _originalLoadConfig = (cardRecognitionService as any).loadConfig;
  ...
  describe('recognizeCard', () => {
    ...
    it('should recognize card successfully', async () => {
      const _result = await cardRecognitionService.recognizeCard(mockRequest);
    ...
    it('should validate request parameters', async () => {
      const _invalidRequest = { ...mockRequest, imageData: '' };

      const _result = await cardRecognitionService.recognizeCard(invalidRequest);
    ...
    it('should handle unsupported image format', async () => {
      const _invalidRequest = { ...mockRequest, imageFormat: 'gif' as any };
    ...
    it('should handle image size limits', async () => {
      ...
      const _largeImageData = 'a'.repeat(15 * 1024 * 1024); // 15MB string
      const _invalidRequest = { ...mockRequest, imageData: largeImageData };
    ...
    it('should handle very small images', async () => {
      const _smallImageData = 'abc'; // Very small string
      const _invalidRequest = { ...mockRequest, imageData: smallImageData };
  ...
  describe('recognizeCardsBatch', () => {
    ...
    it('should process batch asynchronously', async () => {
      ...
      const _status = cardRecognitionService.getBatchJobStatus(result.batchId);
      expect(status).toBeDefined();
      expect(status.batchId).toBe(result.batchId);
    });

    it('should handle empty batch request', async () => {
      const _emptyBatchRequest = { ...mockBatchRequest, images: [] };
  ...
  describe('startRealtimeRecognition', () => {
    ...
    it('should start realtime recognition', async () => {
      const _onFrameProcessed = jest.fn();
    ...
    it('should stop existing realtime recognition before starting new one', async () => {
      const _onFrameProcessed1 = jest.fn();
      const _onFrameProcessed2 = jest.fn();

      await cardRecognitionService.startRealtimeRecognition(onFrameProcessed1);
      const _firstInterval = (cardRecognitionService as any).realtimeInterval;

      await cardRecognitionService.startRealtimeRecognition(onFrameProcessed2);
      const _secondInterval = (cardRecognitionService as any).realtimeInterval;
    ...
    it('should handle realtime recognition errors', async () => {
      ...
      const _originalCaptureAndProcessFrame = (cardRecognitionService as any)
  ...
  describe('getRecognitionHistory', () => {
    ...
    it('should handle API errors', async () => {
      const _originalCallGetHistoryAPI = (cardRecognitionService as any)
        .callGetHistoryAPI;
  ...
  describe('submitUserFeedback', () => {
    ...
    it('should handle API errors', async () => {
      const _originalCallSubmitFeedbackAPI = (cardRecognitionService as any)
  ...
  describe('getRecognitionStats', () => {
    ...
    it('should handle API errors', async () => {
      const _originalCallGetStatsAPI = (cardRecognitionService as any)
        .callGetStatsAPI;
  ...
  describe('getSupportedGames', () => {
    it('should return supported games', () => {
      const _games = cardRecognitionService.getSupportedGames();
  ...
  describe('getConfig', () => {
    it('should return configuration copy', () => {
      ...
      const _originalConfig = (cardRecognitionService as any).config;
  ...
  describe('updateConfig', () => {
    ...
    it('should update configuration', async () => {
      ...
      const _updatedConfig = cardRecognitionService.getConfig();
    ...
    it('should handle config update errors', async () => {
      const _originalSaveConfig = (cardRecognitionService as any).saveConfig;
      (cardRecognitionService as any).saveConfig = jest
        .fn()
        .mockRejectedValue(new Error('Save error'));

      const _updates = { defaultOptions: { confidenceThreshold: 0.9 } };
  ...
  describe('getBatchJobStatus', () => {
    ...
    it('should return null for non-existent batch', () => {
      const _status = cardRecognitionService.getBatchJobStatus('non-existent');
    ...
    it('should return batch status for existing batch', async () => {
      ...
      const _status = cardRecognitionService.getBatchJobStatus(batch.batchId);
  ...
  describe('private methods', () => {
    ...
    it('should generate unique batch IDs', () => {
      const _id1 = (cardRecognitionService as any).generateBatchId();
      const _id2 = (cardRecognitionService as any).generateBatchId();
    ...
    it('should create mock card data', () => {
      const _mockCard = (cardRecognitionService as any).createMockCard();
    ...
    it('should create mock features', () => {
      const _mockFeatures = (cardRecognitionService as any).createMockFeatures();
    ...
    it('should create mock metadata', () => {
      const _mockMetadata = (cardRecognitionService as any).createMockMetadata();
