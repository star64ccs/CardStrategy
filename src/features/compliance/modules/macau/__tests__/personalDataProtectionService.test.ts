...
describe('MacauPersonalDataProtectionService', () => {
  ...
  describe('validateDataProcessing', () => {
    it('應該通過合規的資料處理', () => {
      ...
      const _result = service.validateDataProcessing(processing);
  ...
  describe('processDataSubjectRequest', () => {
    it('應該處理資料存取請求', () => {
      ...
      const _result = service.processDataSubjectRequest(request);
  ...
  describe('validateCrossBorderTransfer', () => {
    it('應該通過合規的跨境傳輸', () => {
      ...
      const _result = service.validateCrossBorderTransfer(transfer);
  ...
  describe('getDataSubjectRequests', () => {
    it('應該返回資料主體請求記錄', () => {
      const _requests = service.getDataSubjectRequests();
