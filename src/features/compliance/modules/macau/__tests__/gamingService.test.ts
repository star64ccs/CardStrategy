...
describe('MacauGamingService', () => {
  ...
  describe('validateGamingLicense', () => {
    it('應該通過有效的博彩執照', () => {
      const license: MacauGamingLicense = {
        ...
        restrictions: ['不得向未成年人提供博彩Service'],
      ...
      const _result = service.validateGamingLicense(license);
  ...
  describe('validateGamingOperation', () => {
    it('應該通過合規的博彩營運', () => {
      ...
      const _result = service.validateGamingOperation(operation);
  ...
  describe('validateResponsibleGaming', () => {
    it('應該通過合規的負責任博彩', () => {
      const responsibleGaming: MacauResponsibleGaming = {
        ...
        supportServices: ['諮詢熱線', '輔導Service'],
        complianceStatus: MacauComplianceStatus.COMPLIANT,
        violations: [],
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      const _result = service.validateResponsibleGaming(responsibleGaming);
  ...
  describe('validateAntiMoneyLaundering', () => {
    it('應該通過合規的反洗錢措施', () => {
      ...
      const _result = service.validateAntiMoneyLaundering(aml);
