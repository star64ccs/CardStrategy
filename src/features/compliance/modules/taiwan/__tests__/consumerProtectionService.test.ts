...
describe('TaiwanConsumerProtectionService', () => {
  ...
  describe('getInstance', () => {
    it('應該返回單例實例', () => {
      const _instance1 = TaiwanConsumerProtectionService.getInstance();
      const _instance2 = TaiwanConsumerProtectionService.getInstance();
  ...
  describe('processConsumerRightsRequest', () => {
    it('應該處理安全權請求', () => {
      ...
      const _result = service.processConsumerRightsRequest(
