...
describe('ConsentManagementModule', () => {
  ...
  describe('單例模式測試', () => {
    test('應該返回相同的實例', () => {
      const _instance1 = ConsentManagementModule.getInstance();
      const _instance2 = ConsentManagementModule.getInstance();
  ...
  describe('初始化測試', () => {
    ...
    test('應該使用自定義配置初始化', async () => {
      ...
      const _result = await consentModule.initialize(customConfig);
      expect(result).toBe(true);
    });
  });
  ...
  describe('同意驗證測試', () => {
    ...
    test('應該檢測缺失的同意', () => {
      const _result = consentModule.validateConsent('user_999', 'essential');
  ...
  describe('同意撤銷測試', () => {
    ...
    test('應該成功撤銷單個同意', () => {
      ...
      const _result = consentModule.withdrawConsent(withdrawalRequest);
    ...
    test('應該成功撤銷多個同意', () => {
      ...
      const _marketingValidation = consentModule.validateConsent(
        'user_123',
        'marketing'
      );
  ...
  describe('同意更新測試', () => {
    ...
    test('應該成功更新同意類型', () => {
      ...
      const _originalConsent = consentModule.collectConsent(
        'user_123',
        'functional',
        'implicit',
        evidence
      ...
      const _newConsent = consentModule.updateConsent(updateRequest);
  ...
  describe('用戶同意狀態測試', () => {
    ...
    test('應該獲取用戶所有同意狀態', () => {
      ...
      const _status = consentModule.getUserConsentStatus('user_123');
  ...
  describe('同意報告測試', () => {
    ...
    test('應該生成指定時期的報告', () => {
      ...
      const _report = consentModule.generateConsentReport(period);
  ...
  describe('功能測試', () => {
    ...
    test('應該處理複雜的同意場景', () => {
      ...
      const _analyticsConsent = consentModule.collectConsent(
        'user_123',
        'analytics',
        'explicit',
        evidence
      );
      const _marketingConsent = consentModule.collectConsent(
        'user_123',
        'marketing',
        'implicit',
        evidence
      ...
      const _updatedMarketingValidation = consentModule.validateConsent(
        'user_123',
        'marketing'
      );
