...
describe('ServiceWorkerService', () => {
  ...
  describe('初始化測試', () => {
    ...
    test('應該處理非 Web 平台', async () => {
      const _iosService = new (ServiceWorkerService as any)();
    ...
    test('應該處理 Service Worker 不支持的情況', async () => {
      const _noSwService = new (ServiceWorkerService as any)();
      ...
      const _result = await noSwService.initialize(mockConfig);
  ...
  describe('Service Worker 狀態測試', () => {
    ...
    test('應該獲取 Service Worker 狀態', () => {
      const _status = service.getServiceWorkerStatus();
  ...
  describe('緩存管理測試', () => {
    ...
    test('應該緩存單個 URL', async () => {
      const _result = await service.cacheUrl('https://example.com/test');
    ...
    test('應該處理緩存失敗', async () => {
      ...
      const _result = await service.cacheUrl('https://example.com/fail');
  ...
  describe('事件處理測試', () => {
    ...
    test('應該處理控制器變化', () => {
      const _controllerChangeHandler =
        mockNavigator.serviceWorker.addEventListener.mock.calls.find(
  ...
  describe('緩存策略測試', () => {
    ...
    test('應該清理舊版本緩存', async () => {
      const _cleanupService = new (ServiceWorkerService as any)();
  ...
  describe('單例模式測試', () => {
    test('應該返回相同的實例', () => {
      const _instance1 = ServiceWorkerService.getInstance();
      const _instance2 = ServiceWorkerService.getInstance();
