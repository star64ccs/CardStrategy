...
describe('RealtimeUpdateService', () => {
  ...
  describe('handleCardUpdate', () => {
    ...
    it('should handle card update successfully', async () => {
      const _cardId = 'card1';
      const _action = 'update' as const;
      const _data = { name: 'Updated Card', price: 100 };
  ...
  describe('handleUserStatusUpdate', () => {
    ...
    it('should handle user status update successfully', async () => {
      const _userId = 'user1';
      const _status = 'online' as const;
      const _data = { device: 'mobile' };
  ...
  describe('getStats', () => {
    it('should return stats copy', () => {
      const _stats1 = realtimeUpdateService.getStats();
      const _stats2 = realtimeUpdateService.getStats();
  ...
  describe('clearStats', () => {
    it('should clear stats successfully', () => {
      ...
      const _stats = realtimeUpdateService.getStats();
  ...
  describe('private methods', () => {
    ...
    describe('handleWebSocketMessage', () => {
      it('should process user_update messages', () => {
        ...
        const _originalProcessQueue = (realtimeUpdateService as any)
          .processQueue;
    ...
    describe('executeUpdate', () => {
      ...
      it('should handle handler errors gracefully', async () => {
        const _mockHandler = jest.fn().mockImplementation(() => {
    ...
    describe('generateUpdateId', () => {
      it('should generate unique update IDs', () => {
        const _id1 = (realtimeUpdateService as any).generateUpdateId();
        const _id2 = (realtimeUpdateService as any).generateUpdateId();
