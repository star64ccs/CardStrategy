...
class BackupService {
  ...
  async createDatabaseBackup() {
    ...
    try {
      ...
      const { stdout: _stdout, stderr } = // eslint-disable-next-line no-unused-varsawait execAsync(command, { env });
  ...
  async createFileBackup() {
    ...
    try {
      ...
      const { stdout: _stdout, stderr } = // eslint-disable-next-line no-unused-varsawait execAsync(command);
