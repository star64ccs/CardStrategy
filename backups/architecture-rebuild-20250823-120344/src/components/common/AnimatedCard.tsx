...
export const FadeInCard: React.FC<
  Omit<AnimatedCardProps, 'animationType'>
> = props => <AnimatedCard {...props} animationType='fadeIn' />;

export const SlideUpCard: React.FC<
  Omit<AnimatedCardProps, 'animationType'>
> = props => <AnimatedCard {...props} animationType='slideUp' />;

export const BounceCard: React.FC<
  Omit<AnimatedCardProps, 'animationType'>
> = props => <AnimatedCard {...props} animationType='bounce' />;

export const FlipCard: React.FC<
  Omit<AnimatedCardProps, 'animationType'>
> = props => <AnimatedCard {...props} animationType='flip' />;

export const GlowCard: React.FC<
  Omit<AnimatedCardProps, 'glowEffect'>
> = props => <AnimatedCard {...props} glowEffect={true} />;

export const PulseCard: React.FC<
  Omit<AnimatedCardProps, 'pulseEffect'>
> = props => <AnimatedCard {...props} pulseEffect={true} />;
