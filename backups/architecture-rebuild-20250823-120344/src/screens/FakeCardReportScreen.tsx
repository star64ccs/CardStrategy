...
const FAKE_CARD_REASONS = [
  {
    id: 'printing_quality',
    label: '印刷品質差',
    description: '顏色模糊、字體不清',
  },
  {
    id: 'material_different',
    label: '材質不同',
    description: '卡片厚度、質感異常',
  },
  {
    id: 'color_mismatch',
    label: '顏色不匹配',
    description: '與正版顏色有明顯差異',
  },
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.charCountText}>{description.length}/1000 字符</Text>
      </View>
