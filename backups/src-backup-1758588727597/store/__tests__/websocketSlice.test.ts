...
import websocketReducer, {
  addSubscription,
  _broadcastMessage as broadcastMessage,
  clearError,
  clearMessages,
  clearNotifications,
  _connectWebSocket as connectWebSocket,
  _disconnectWebSocket as disconnectWebSocket,
  _initializeWebSocket as initializeWebSocket,
  _joinRoom as joinRoom,
  _leaveRoom as leaveRoom,
  receiveMessage,
  _reconnectWebSocket as reconnectWebSocket,
  removeSubscription,
  _selectHasError as selectHasError,
  _selectIsConnected as selectIsConnected,
  _selectIsConnecting as selectIsConnecting,
  _selectStatus as selectStatus,
  _sendWebSocketMessage as sendWebSocketMessage,
  setError,
  setVisibility,
...
describe('WebSocket Slice', () => {
  ...
  describe('reducers', () => {
    describe('receiveMessage', () => {
      ...
      it('should limit message history', () => {
        ...
        const maxMessages = initialState.config.messageHistoryLimit;
      ...
      it('should limit notification history', () => {
        const initialState = store.getState().websocket;
        const maxNotifications = initialState.config.notificationLimit;
  ...
  describe('async thunks', () => {
    ...
    describe('initializeWebSocket', () => {
      ...
      it('should handle initialization error', async () => {
        ...
        const result = await store.dispatch(initializeWebSocket({}));
    ...
    describe('connectWebSocket', () => {
      ...
      it('should handle connection error', async () => {
        ...
        const result = await store.dispatch(connectWebSocket());
    ...
    describe('sendWebSocketMessage', () => {
      ...
      it('should handle send error', async () => {
        ...
        const result = await store.dispatch(sendWebSocketMessage(message));
  ...
  describe('selectors', () => {
    it('should select connection status correctly', () => {
      ...
      const connectingState = store.getState();
