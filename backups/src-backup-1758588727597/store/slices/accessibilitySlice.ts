...
// 異步 Action Creators
export const initializeAccessibility = createAsyncThunk(
...
export const updateAccessibilityConfig = createAsyncThunk(
...
export const runAccessibilityTest = createAsyncThunk(
  'accessibility/runTest',
  async (config?: Partial<AccessibilityTestConfig>) => {
    const result = await accessibilityService.runTest(config);
    return result;
  }
);

export const fixAccessibilityIssues = createAsyncThunk(
...
const accessibilitySlice = createSlice({
  ...
  reducers: {
    ...
    updateSuggestion: (
      ...
      const { id, updates } = action.payload;
      const suggestionIndex = state.suggestions.findIndex(
...
// 導出 Selectors
export const selectAccessibilityState = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility;
export const selectAccessibilityConfig = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.config;
export const selectFocusManager = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.focusManager;
export const selectCurrentFocus = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.focusManager.currentFocus;
export const selectAccessibilityMode = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.mode;
export const selectAssistiveTechnology = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.assistiveTechnology;
export const selectAccessibilityScore = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.score;
export const selectAccessibilityIssues = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.issues;
export const selectAccessibilitySuggestions = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.suggestions;
export const selectKeyboardNavigationEnabled = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.config.keyboardNavigation?.enabled || false;
export const selectScreenReaderEnabled = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.config.screenReader?.enabled || false;
export const selectHighContrastEnabled = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.config.highContrast;
export const selectReducedMotionEnabled = (state: {
  accessibility: AccessibilityState;
}) => state.accessibility.config.reducedMotion;
export const selectLargeTextEnabled = (state: {
  accessibility: AccessibilityState;
