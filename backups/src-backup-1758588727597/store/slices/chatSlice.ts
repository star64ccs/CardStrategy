...
export const updateSessionPriority = createAsyncThunk(
...
export const addSessionTag = createAsyncThunk(
  'chat/addSessionTag',
  async (
...
export const removeSessionTag = createAsyncThunk(
...
export const selectChatError = (state: { chat: ChatState }) =>
  state.chat.error;
export const selectIsTyping = (state: { chat: ChatState }) =>
  state.chat.isTyping;
export const selectQuickReplies = (state: { chat: ChatState }) =>
  state.chat.quickReplies;
export const selectSuggestedActions = (state: { chat: ChatState }) =>
