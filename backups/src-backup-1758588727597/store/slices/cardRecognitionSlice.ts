...
export const recognizeCard = createAsyncThunk(
  ...
  async (request: CardRecognitionRequest, { rejectWithValue }) => {
    try {
      const response = await cardRecognitionService.recognizeCard(request);
 ...
 * 批量識別卡牌
 */
export const recognizeCardsBatch = createAsyncThunk(
 ...
 * 獲取識別統計
 */
export const getRecognitionStats = createAsyncThunk(
 ...
 * 更新配置
 */
export const updateRecognitionConfig = createAsyncThunk(
  ...
  async (updates: Partial<RecognitionConfig>, { rejectWithValue }) => {
    try {
      ...
      const newConfig = cardRecognitionService.getConfig();
      return newConfig;
    } catch (error: unknown) {
...
export const getBatchJobStatus = createAsyncThunk(
  ...
  async (batchId: string, { rejectWithValue }) => {
    try {
      const status = cardRecognitionService.getBatchJobStatus(batchId);
      if (!status) {
...
// Slice 定義
const cardRecognitionSlice = createSlice({
  ...
  reducers: {
    ...
    updateBatchJob: (
      ...
      const index = state.batchJobs.findIndex(
...
// Selectors
export const selectIsRecognizing = (state: {
...
export const selectRecognitionError = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.recognitionError;

export const selectRecognitionHistory = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.history;

export const selectIsLoadingHistory = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.isLoadingHistory;

export const selectHistoryError = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.historyError;

export const selectBatchJobs = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.batchJobs;

export const selectIsBatchProcessing = (state: {
  cardRecognition: RecognitionState;
...
export const selectIsRealtimeActive = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.isRealtimeActive;

export const selectRealtimeFrames = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.realtimeFrames;

export const selectRealtimeError = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.realtimeError;

export const selectRecognitionConfig = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.config;

export const selectIsConfigLoading = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.isConfigLoading;

export const selectConfigError = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.configError;

export const selectRecognitionStats = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.stats;

export const selectIsStatsLoading = (state: {
  cardRecognition: RecognitionState;
...
export const selectShowAlternatives = (state: {
  cardRecognition: RecognitionState;
}) => state.cardRecognition.showAlternatives;

export const selectCropMode = (state: { cardRecognition: RecognitionState }) =>
  state.cardRecognition.cropMode;

export const selectCropData = (state: { cardRecognition: RecognitionState }) =>
