...
export class CloudflareStorageService {
  ...
  async uploadFile(
    ...
    try {
      ...
      const response = await api.post(`/api/storage/cloudflare/upload`, {
        key,
  ...
  async downloadFile(
    ...
    try {
      ...
      const response = await api.get(`/api/storage/cloudflare/download`, {
        params: {
          key,
          accountId: this.accountId,
          zoneId: this.zoneId,
  ...
  async deleteFile(key: string): Promise<ApiResponse> {
    try {
      ...
      const response = await api.delete(`/api/storage/cloudflare/delete`, {
        params: {
          key,
          accountId: this.accountId,
          zoneId: this.zoneId,
  ...
  async listFiles(
    ...
    try {
      ...
      const response = await api.get(`/api/storage/cloudflare/list`, {
        params: {
          accountId: this.accountId,
          zoneId: this.zoneId,
          prefix,
  ...
  async getFileUrl(
    ...
    try {
      ...
      const response = await api.get(`/api/storage/cloudflare/url`, {
        params: {
          key,
          accountId: this.accountId,
          zoneId: this.zoneId,
  ...
  async copyFile(
    ...
    try {
      ...
      const response = await api.post(`/api/storage/cloudflare/copy`, {
        sourceKey,
        destinationKey,
        accountId: this.accountId,
        zoneId: this.zoneId,
  ...
  async getFileMetadata(key: string): Promise<ApiResponse<CloudflareFile>> {
    try {
      ...
      const response = await api.get(`/api/storage/cloudflare/metadata`, {
        params: {
          key,
          accountId: this.accountId,
          zoneId: this.zoneId,
  ...
  async getServiceStats(): Promise<ApiResponse> {
    try {
      ...
      const listResponse = await this.listFiles({ limit: 1 });
...
export const cloudflareService = new CloudflareStorageService();
