...
export class MembershipService {
  ...
  async getMembershipTier(tierId: string): Promise<any> {
    try {
      ...
      const response = await api.get(`${this.baseUrl}/tiers/${tierId}`);
  ...
  async cancelMembership(userId: string): Promise<any> {
    try {
      ...
      const response = await api.post(`${this.baseUrl}/cancel`, { userId });
  ...
  async updateAutoRenew(userId: string, autoRenew: boolean): Promise<any> {
    try {
      ...
      const response = await api.put(`${this.baseUrl}/auto-renew`, {
        userId,
        autoRenew,
      });
  ...
  async getUserUsage(userId: string): Promise<any> {
    try {
      ...
      const response = await api.get(`${this.baseUrl}/usage/${userId}`);
  ...
  async startTrial(): Promise<any> {
    try {
      ...
      const response = await api.post(`${this.baseUrl}/trial/start`);
  ...
  async checkFeatureUsage(feature: string): Promise<any> {
    try {
      ...
      const response = await api.get(`${this.baseUrl}/usage/${feature}`);
  ...
  async useFeature(feature: string): Promise<any> {
    try {
      ...
      const response = await api.post(`${this.baseUrl}/usage/${feature}`);
