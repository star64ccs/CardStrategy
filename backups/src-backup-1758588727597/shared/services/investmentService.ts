...
export class InvestmentService {
  ...
  async createPortfolio(data: CreatePortfolioRequest): Promise<any> {
    try {
      ...
      const response = await api.post(`${this.baseUrl}/portfolios`, data);
  ...
  async generateInvestmentAdvice(cardId: string, userId: string): Promise<any> {
    try {
      ...
      const response = await api.post(`${this.baseUrl}/advice/generate`, {
        cardId,
        userId,
      });
  ...
  async getInvestments(): Promise<any> {
    try {
      ...
      const response = await api.get(`${this.baseUrl}/investments`);
