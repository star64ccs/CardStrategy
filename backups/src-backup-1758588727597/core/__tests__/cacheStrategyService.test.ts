...
describe('CacheStrategyService', () => {
  ...
  describe('緩存操作', () => {
    ...
    it('應該成功設置緩存', async () => {
      ...
      const cachedValue = await cacheStrategyService.get(key);
    ...
    it('應該成功獲取緩存', async () => {
      ...
      await cacheStrategyService.set(key, value);
      const result = await cacheStrategyService.get(key);

      expect(result).toEqual(value);
    });

    it('應該在緩存未命中時返回null', async () => {
      const result = await cacheStrategyService.get('non-existent-key');
    ...
    it('應該成功刪除緩存', async () => {
      ...
      await cacheStrategyService.set(key, value);
      const deleted = await cacheStrategyService.delete(key);
  ...
  describe('標籤管理', () => {
    ...
    it('應該成功根據標籤刪除緩存', async () => {
      ...
      const deletedCount = await cacheStrategyService.deleteByTags(['user']);
  ...
  describe('緩存策略', () => {
    ...
    it('應該自動選擇最佳策略', async () => {
      ...
      const value = { data: 'critical-data' };
  ...
  describe('緩存統計', () => {
    ...
    it('應該返回緩存統計信息', () => {
      const stats = cacheStrategyService.getStats();
  ...
  describe('緩存策略管理', () => {
    ...
    it('應該返回緩存策略', () => {
      const strategies = cacheStrategyService.getStrategies();
    ...
    it('應該返回緩存層', () => {
      const layers = cacheStrategyService.getLayers();
  ...
  describe('緩存預熱', () => {
    ...
    it('應該成功預熱緩存', async () => {
      ...
      for (const key of keys) {
        const value = await cacheStrategyService.get(key);
  ...
  describe('服務狀態', () => {
    it('應該返回服務狀態', () => {
      const status = cacheStrategyService.getStatus();
  ...
  describe('內存管理', () => {
    ...
    it('應該在內存不足時清理項目', async () => {
      ...
      // 驗證項目被設置
      const result = await cacheStrategyService.get('large-key');
