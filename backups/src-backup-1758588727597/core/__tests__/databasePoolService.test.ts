...
describe('DatabasePoolService', () => {
  ...
  describe('連接管理', () => {
    ...
    it('應該成功獲取連接', async () => {
      const connection = await databasePoolService.getConnection();
    ...
    it('應該成功釋放連接', async () => {
      ...
      // 驗證連接已釋放（通過統計信息）
      const stats = databasePoolService.getConnectionStats();
  ...
  describe('查詢執行', () => {
    ...
    it('應該成功執行查詢', async () => {
      const result = await databasePoolService.executeQuery(
        'SELECT * FROM users'
      );
    ...
    it('應該記錄查詢指標', async () => {
      ...
      const metrics = databasePoolService.getQueryMetrics();
  ...
  describe('健康檢查', () => {
    ...
    it('應該返回連接池健康狀態', () => {
      const health = databasePoolService.getPoolHealth();
  ...
  describe('服務狀態', () => {
    it('應該返回服務狀態', async () => {
      const status = databasePoolService.getStatus();
