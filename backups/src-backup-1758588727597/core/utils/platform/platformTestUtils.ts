...
export function platformTest(platforms: ('ios' | 'android' | 'web')[]) {
  return function (
    ...
    descriptor.value = function (...args: unknown[]) {
      const env = PlatformTestEnvironment.getInstance();
      const currentPlatform = env.getCurrentPlatform();
...
// 導出單例實例
export const platformTestEnv = PlatformTestEnvironment.getInstance();
