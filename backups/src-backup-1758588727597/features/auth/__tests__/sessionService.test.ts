...
describe('SessionService', () => {
  ...
  describe('getInstance', () => {
    it('should return singleton instance', () => {
      const instance1 = sessionService;
      const instance2 = sessionService;
  ...
  describe('initialize', () => {
    ...
    it('should restore existing valid session', async () => {
      ...
      const hasRestoreCall = infoCalls.some(
        call =>
  ...
  describe('getSessions', () => {
    ...
    it('should handle get sessions error', async () => {
      ...
      const originalCall = (sessionService as any).callGetSessionsAPI;
  ...
  describe('getSessionConfig', () => {
    ...
    it('should get session config successfully', async () => {
      const config = await sessionService.getSessionConfig();
    ...
    it('should return default config on error', async () => {
      // Mock the API call to fail
      const originalCall = (sessionService as any).callGetSessionConfigAPI;
  ...
  describe('getSessionActivities', () => {
    ...
    it('should get session activities successfully', async () => {
      const activities = await sessionService.getSessionActivities();
  ...
  describe('getSessionSecurityInfo', () => {
    ...
    it('should get security info successfully', async () => {
      const securityInfo = await sessionService.getSessionSecurityInfo();
  ...
  describe('recordActivity', () => {
    ...
    it('should handle activity recording error gracefully', async () => {
      // Mock the API call to fail
      const originalCall = (sessionService as any).callRecordActivityAPI;
  ...
  describe('updateSessionActivity', () => {
    ...
    it('should update session activity', async () => {
      const { currentSession } = sessionService as any;
      const originalLastActiveAt = currentSession.lastActiveAt;
