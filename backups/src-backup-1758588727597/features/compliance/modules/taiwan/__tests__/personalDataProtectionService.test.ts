...
describe('TaiwanPersonalDataProtectionService', () => {
  ...
  describe('getInstance', () => {
    it('應該返回單例實例', () => {
      const instance1 = TaiwanPersonalDataProtectionService.getInstance();
      const instance2 = TaiwanPersonalDataProtectionService.getInstance();
  ...
  describe('validatePersonalDataProcessing', () => {
    it('應該驗證合規的個人資料處理', () => {
      ...
      const result = service.validatePersonalDataProcessing(processing);
  ...
  describe('processDataSubjectRequest', () => {
    it('應該處理查詢請求', () => {
      const result = service.processDataSubjectRequest(
        TaiwanDataSubjectRight.ACCESS,
        'user123',
        { dataType: 'contact' }
      );
  ...
  describe('manageCrossBorderTransfer', () => {
    it('應該管理有效的跨境傳輸', () => {
      ...
      const result = service.manageCrossBorderTransfer(transfer);
  ...
  describe('handleDataSubjectRights', () => {
    it('應該處理多個權利請求', () => {
      ...
      const result = service.handleDataSubjectRights(rights, 'user123');
    ...
    it('應該處理空權利列表', () => {
      const result = service.handleDataSubjectRights([], 'user123');
