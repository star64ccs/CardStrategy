...
describe('AppleAppStoreService', () => {
  ...
  describe('validateAppInfo', () => {
    it('應該驗證有效的應用程式資訊', () => {
      ...
      const result = service.validateAppInfo(appInfo);
  ...
  describe('validateInAppPurchase', () => {
    it('應該驗證有效的內購項目', () => {
      ...
      const result = service.validateInAppPurchase(purchase);
  ...
  describe('validateSubscription', () => {
    it('應該驗證有效的訂閱項目', () => {
      ...
      const result = service.validateSubscription(subscription);
  ...
  describe('validatePrivacyPolicy', () => {
    it('應該驗證有效的隱私政策', () => {
      ...
      const result = service.validatePrivacyPolicy(policy);
  ...
  describe('processAppReview', () => {
    it('應該處理完整的應用程式審核', () => {
      ...
      const review = service.processAppReview(
        appInfo,
        inAppPurchases,
        subscriptions,
        privacyPolicy
