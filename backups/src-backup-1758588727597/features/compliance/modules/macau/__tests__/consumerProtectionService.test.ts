...
describe('MacauConsumerProtectionService', () => {
  ...
  describe('validateProductLabeling', () => {
    it('應該通過合規的產品標籤', () => {
      ...
      const result = service.validateProductLabeling(labeling);
  ...
  describe('processConsumerComplaint', () => {
    it('應該處理產品缺陷投訴', () => {
      ...
      const result = service.processConsumerComplaint(complaint);
  ...
  describe('validateAdvertising', () => {
    it('應該通過合規的廣告', () => {
      ...
      const result = service.validateAdvertising(advertising);
  ...
  describe('getComplaints', () => {
    it('應該返回投訴記錄', () => {
      const complaints = service.getComplaints();
