...
describe('MarketingComplianceModule', () => {
  ...
  describe('單例模式', () => {
    it('應該返回相同的實例', () => {
      const instance1 = MarketingComplianceModule.getInstance();
      const instance2 = MarketingComplianceModule.getInstance();
  ...
  describe('初始化', () => {
    it('應該成功初始化模組', async () => {
      const result = await marketingComplianceModule.initialize();
    ...
    it('應該使用自定義配置初始化', async () => {
      ...
      const result = await marketingComplianceModule.initialize(customConfig);
      expect(result).toBe(true);
    });
  });
  ...
  describe('營銷同意管理', () => {
    it('應該驗證營銷同意', () => {
      const result = marketingComplianceModule.validateMarketingConsent(
        'user123',
        'email'
      );
    ...
    it('應該管理退出請求', () => {
      const result = marketingComplianceModule.manageOptOut('user456', 'sms');
    ...
    it('應該處理不同渠道的同意', () => {
      const emailResult = marketingComplianceModule.validateMarketingConsent(
        'user1',
        'email'
      );
      const smsResult = marketingComplianceModule.validateMarketingConsent(
        'user1',
        'sms'
      );
      const pushResult = marketingComplianceModule.validateMarketingConsent(
        'user1',
        'push'
      );
  ...
  describe('電子郵件合規', () => {
    it('應該驗證合規的電子郵件', () => {
      ...
      const result = marketingComplianceModule.validateEmailMarketing(email);
    ...
    it('應該執行CAN-SPAM檢查', () => {
      ...
      const result = marketingComplianceModule.enforceCANSPAM(email);
  ...
  describe('廣告透明度', () => {
    it('應該追蹤透明廣告', () => {
      ...
      const result = marketingComplianceModule.trackAdTransparency(ad);
    ...
    it('應該驗證廣告內容', () => {
      ...
      const result = marketingComplianceModule.validateAdContent(ad);
  ...
  describe('重置功能', () => {
    it('應該重置模組狀態', async () => {
      ...
      const result = marketingComplianceModule.validateEmailMarketing(newEmail);
  ...
  describe('功能場景測試', () => {
    it('應該處理完整的營銷合規流程', () => {
      // 1. 驗證用戶同意
      const consentResult = marketingComplianceModule.validateMarketingConsent(
        'scenario_user',
        'email'
      );
      ...
      // 4. 執行CAN-SPAM檢查
      const canspamResult = marketingComplianceModule.enforceCANSPAM(email);
      ...
      // 7. 驗證廣告內容
      const contentResult = marketingComplianceModule.validateAdContent(ad);
    ...
    it('應該處理用戶退出流程', () => {
      ...
      // 2. 用戶選擇退出
      const optoutResult = marketingComplianceModule.manageOptOut(
        'optout_user',
        'email'
      );

      // 3. 再次驗證同意狀態
      const newConsentResult =
