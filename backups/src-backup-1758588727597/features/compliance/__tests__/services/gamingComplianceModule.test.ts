...
describe('GamingComplianceModule', () => {
  ...
  describe('單例模式', () => {
    it('應該返回相同的實例', () => {
      const instance1 = GamingComplianceModule.getInstance();
      const instance2 = GamingComplianceModule.getInstance();
  ...
  describe('初始化', () => {
    it('應該成功初始化模組', async () => {
      const result = await gamingComplianceModule.initialize();
    ...
    it('應該使用自定義配置初始化', async () => {
      ...
      const result = await gamingComplianceModule.initialize(customConfig);
      expect(result).toBe(true);
    });
  });
  ...
  describe('遊戲內容合規檢查', () => {
    it('應該檢查適合所有年齡的遊戲', () => {
      ...
      const result = gamingComplianceModule.checkGameContentCompliance(game);
  ...
  describe('玩家年齡驗證', () => {
    it('應該驗證成年玩家', () => {
      const result = gamingComplianceModule.verifyPlayerAge(
        'player123',
        25,
        'Taiwan'
      );
    ...
    it('應該根據地區應用不同規則', () => {
      const taiwanResult = gamingComplianceModule.verifyPlayerAge(
        'player1',
        16,
        'Taiwan'
      );
      const macauResult = gamingComplianceModule.verifyPlayerAge(
        'player2',
        16,
        'Macau'
      );
  ...
  describe('合規報告生成', () => {
    it('應該生成合規報告', () => {
      const report = gamingComplianceModule.generateComplianceReport();
  ...
  describe('邊界條件', () => {
    ...
    it('應該處理極端年齡值', () => {
      const result1 = gamingComplianceModule.verifyPlayerAge(
        'player1',
        0,
        'Taiwan'
      );
      const result2 = gamingComplianceModule.verifyPlayerAge(
        'player2',
        120,
        'Taiwan'
      );
  ...
  describe('功能場景測試', () => {
    it('應該處理複雜的遊戲合規場景', () => {
      ...
      // 驗證成年玩家可以正常交易
      const adultPlayer = gamingComplianceModule.verifyPlayerAge(
        'adult_player',
        25,
        'Taiwan'
      );
    ...
    it('應該處理未成年玩家的限制場景', () => {
      // 驗證未成年玩家
      const minorPlayer = gamingComplianceModule.verifyPlayerAge(
        'minor_player',
        15,
        'Taiwan'
      );
