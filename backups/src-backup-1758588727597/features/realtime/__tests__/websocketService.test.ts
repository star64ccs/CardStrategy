...
describe('WebSocketService', () => {
  ...
  describe('getInstance', () => {
    it('should return singleton instance', () => {
      const instance1 = (websocketService as any).constructor.getInstance();
      const instance2 = (websocketService as any).constructor.getInstance();
  ...
  describe('getBatchJobStatus', () => {
    it('should return null for non-existent batch', () => {
      const status = websocketService.getBatchJobStatus('non-existent');
    ...
    it('should return batch status for existing batch', () => {
      ...
      const status = websocketService.getBatchJobStatus(batchId);
  ...
  describe('private methods', () => {
    ...
    it('should generate unique message IDs', () => {
      const id1 = (websocketService as any).generateMessageId();
      const id2 = (websocketService as any).generateMessageId();
    ...
    it('should match filter correctly', () => {
      ...
      const result = (websocketService as any).matchesFilter(message, filter);
