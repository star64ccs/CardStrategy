...
describe('PredictionService', () => {
  ...
  describe('performPrediction', () => {
    ...
    it('should perform price prediction successfully', async () => {
      const result = await predictionService.performPrediction(mockRequest);
    ...
    it('should perform trend prediction successfully', async () => {
      ...
      const result = await predictionService.performPrediction(trendRequest);
    ...
    it('should perform volume prediction successfully', async () => {
      ...
      const result = await predictionService.performPrediction(volumeRequest);
    ...
    it('should handle unsupported prediction type gracefully', async () => {
      ...
      // 當前實現會接受任何預測類型並返回結果
      const result = await predictionService.performPrediction(invalidRequest);
      expect(result).toBeDefined();
