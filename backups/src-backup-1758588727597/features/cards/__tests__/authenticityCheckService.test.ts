...
describe('AuthenticityCheckService', () => {
  ...
  describe('getInstance', () => {
    it('should return the same instance', () => {
      const instance1 = authenticityCheckService;
      const instance2 = AuthenticityCheckService.getInstance();
  ...
  describe('getCheckHistory', () => {
    it('should successfully get check history', async () => {
      ...
      const result = await authenticityCheckService.getCheckHistory(
        userId,
        limit
      );
  ...
  describe('getCheckStats', () => {
    it('should successfully get check stats', async () => {
      ...
      const result = await authenticityCheckService.getCheckStats(userId);
  ...
  describe('getCheckOptions', () => {
    it('should successfully get check options', async () => {
      ...
      const result = await authenticityCheckService.getCheckOptions();
