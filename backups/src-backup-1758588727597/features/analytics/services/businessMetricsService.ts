...
class BusinessMetricsService {
  ...
  public async getBusinessMetrics(
    ...
    try {
      ...
      const insights = await this.generateInsights(filteredMetrics);
      ...
      const summary = this.generateSummary(filteredMetrics, insights, alerts);
  ...
  public async generateReport(
    ...
    try {
      const analysis = await this.getBusinessMetrics(filter);
