...
// 轉換為 JSON 格式
export const convertToJSON = (data: AnalysisData): string => {
  try {
...
// 轉換為 CSV 格式
export const convertToCSV = (data: AnalysisData): string => {
  try {
...
export const convertToExcel = (data: AnalysisData): string => {
  try {
...
export const convertToPDF = (data: AnalysisData): string => {
  try {
...
// 格式化數據顯示
export const formatDataForDisplay = (data: AnalysisData): string => {
  try {
    if (Array.isArray(data)) {
...
// 驗證數據格式
export const validateDataFormat = (data: AnalysisData): boolean => {
  try {
