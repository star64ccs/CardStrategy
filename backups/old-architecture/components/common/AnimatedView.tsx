...
export const FadeInView: React.FC<
  Omit<AnimatedViewProps, 'animation'>
> = props => <AnimatedView animation='fadeIn' {...props} />;

export const SlideUpView: React.FC<
  Omit<AnimatedViewProps, 'animation'>
> = props => <AnimatedView animation='slideUp' {...props} />;

export const SlideDownView: React.FC<
  Omit<AnimatedViewProps, 'animation'>
> = props => <AnimatedView animation='slideDown' {...props} />;

export const SlideLeftView: React.FC<
  Omit<AnimatedViewProps, 'animation'>
> = props => <AnimatedView animation='slideLeft' {...props} />;

export const SlideRightView: React.FC<
  Omit<AnimatedViewProps, 'animation'>
> = props => <AnimatedView animation='slideRight' {...props} />;

export const ScaleView: React.FC<
  Omit<AnimatedViewProps, 'animation'>
> = props => <AnimatedView animation='scale' {...props} />;

export const BounceView: React.FC<
  Omit<AnimatedViewProps, 'animation'>
> = props => <AnimatedView animation='bounce' {...props} />;
