...
const DataAnalyzer: React.FC = () => {
  ...
  const [filter, setFilter] = useState<
    'all' | 'market_trend' | 'price_pattern' | 'volume_analysis' | 'correlation'
  >('all');
      ...
      const mockAnalyses: DataAnalysis[] = [
        {
          ...
          title: '龍族卡片市場趨勢分析',
          description:
            '分析顯示龍族卡片在過去30天內整體上漲趨勢明顯，特別是青眼白龍和真紅眼黑龍',
          insights: [
            '龍族卡片平均漲幅15.3%',
            '交易量增加45%',
            '收藏家需求上升',
      ...
      <div className="analyzer-stats">
        ...
        <div className="stat-card">
          <span className="stat-number">
            {analyses
              .reduce((sum, a) => sum + a.dataPoints, 0)
              .toLocaleString()}
          </span>
          ...
          <div key={analysis.id} className="analysis-card">
            <div className="analysis-header">
              ...
              <div className="analysis-confidence">
                <span
                  className={`confidence-badge ${getConfidenceColor(analysis.confidence)}`}
                >
            ...
            <div className="analysis-meta">
              <div className="meta-item">
                ...
                <span className="meta-value">
                  {analysis.dataPoints.toLocaleString()}
                </span>
              </div>
              <div className="meta-item">
