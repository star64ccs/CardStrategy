...
const CardManagement = React.lazy(() =>
  loadModule('cardManagement', './CardList').then((module) => ({
...
const MarketAnalysis = React.lazy(() =>
  loadModule('marketAnalysis', './MarketDashboard').then((module) => ({
    default: module.default,
  }))
);
...
const AIEcosystem = React.lazy(() =>
  loadModule('aiEcosystem', './AIDashboard').then((module) => ({
    default: module.default,
  }))
);
    ...
    <Router>
      <div className="app">
        ...
        <main className="app-main">
          <React.Suspense
            fallback={<div className="loading">載入模組中...</div>}
          >
            <Routes>
